...
#check for updates
try{
    $url = "https://raw.githubusercontent.com/gabomoto1/powershell-profile/main/Microsoft.PowerShell_profile.ps1"
...
if (Test-Path Variable:\newhash) {
    Remove-Variable newhash
}

if (Test-Path Variable:\oldhash) {
    Remove-Variable oldhash
}

if (Test-Path Variable:\url) {
    Remove-Variable url
}
